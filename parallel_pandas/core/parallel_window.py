...
class ParallelRolling:
    ...
    def do_parallel(self, name):
        ...
        elif name in ('aggregate', 'agg'):
            @doc(DOC, func=name)
            def p_func(data, func, *args, executor='processes', **kwargs):
